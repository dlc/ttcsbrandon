...
<div id="main" class="grid_12">
  ...
  <p id="p20120108"><span class="leader">January 8</span> &middot; Our <a href="[% site.uris.schedule %]">new class schedule</a> begins today! The <a href="[% site.uris.calendar %]">calendar</a> has been updated to include the classes at our <a href="[% gmap(lochash.templeterrace.addr) %]" target="_gmap">Temple Terrace</a> location as well as our <a href="[% gmap(lochash.brandon.addr) %]" target="_gmap">Brandon</a> location.</p>
  ...
  <p id="p-20120114"><span class="leader">January 14-15</span> &middot; <a href="[% gmap("1370 Main Street, Dunedin, FL 34698") %]">Dunedin</a> will be hosting a <a href="http://www.usa.taoist.org/Dunedin_January_2012.pdf">Tai Chi Intensive</a>, led by Tony Kwong. Tony is the Treasurer for the <a href="http://www.taoist.org/">International [% abbr.ttcs %]</a> and he's the person who has been training your CIT's the last two years.  He has dedicated himself to helping the rest of us improve in our training faster and more efficiently. Tony hasn't been in our area for several years now. Please take advantage of this asset if you are able.</p>
      ...
      <p><span class="leader">The Fung Loy Kok Institute of Taoism</span> has released a revised International Taoist Tai Chi Centre schedule for 2012. Want to know when the Chinese New Year banquet at the Toronto Centre is? (January 7.) Need to make plans for CIT Week in Orangeville? (August 5-10.) <a href="http://ittcs.files.wordpress.com/2011/10/2012-schedule-11-10-30-v3.pdf">Download the schedule</a>.</p>

      <hr />

      <p id="p-x1"><span class="leader">Welcome</span> to the Brandon Florida branch of the <a href="http://www.usa.taoist.org/">[% abbr.ttcsusa %]</a>.</p>

      <p id="p-x2">Taoist Tai Chi&reg; internal art of [% w("taijiquan") %] is a low impact exercise designed to enhance health. We invite you to join us to learn this ancient Chinese gentle internal art emphasizing relaxation, stretching, health improvement and stress reduction.

      <p id="p-x3">In more than 25 countries around the globe, people are enjoying the many benefits of practicing Taoist Tai Chi&reg; taijiquan in the friendly atmosphere of our volunteer, non-profit organization.</p>

      <p id="p-x4">Experience <a href="[% site.uris.schedule %]">one of our classes</a> for yourself and discover a genuine path for health and tranquility.</p>
